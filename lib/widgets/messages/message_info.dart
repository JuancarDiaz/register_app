...
///
/// Mensaje renderizado después de acciones como ( editar o borrar ) usuarios
/// con un mensaje  personalizado
///
class MessageInfo extends StatelessWidget {
  final String operation;

  const MessageInfo({super.key, required this.operation});
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: const Color.fromARGB(
                  255, 126, 207, 130), // Color del cuadrado
